...
weights = np.load("Am_in_An/A9_in_A0/rounded_1189_841_52_37_weights.npy")

assert weights.shape == (1189, 841) and weights.dtype == np.int64
assert weights.min() >= 0
assert weights.sum() < 517_000_000
...
assert all_rect_sums_at_least(52, 37, 1_000_000)  # horizontal
assert all_rect_sums_at_least(37, 52, 1_000_000)  # vertical